								...
								<div className='grid gap-4 sm:grid-cols-2'>
									<div className='grid gap-2'>
										...
										<input
											...
											className='h-11 w-full rounded-xl border border-border bg-background px-4 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50 appearance-none'
										/>
									</div>
									<div className='grid gap-2'>
										...
										<input
											...
											className='h-11 w-full max-w-full rounded-xl border border-border bg-background px-4 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50 appearance-none'
										/>
									</div>
								</div>
